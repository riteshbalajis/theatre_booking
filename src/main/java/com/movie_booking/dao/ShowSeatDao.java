...
public interface ShowSeatDao {
    ...
    boolean holdSeat(Connection connection,int showSeatId,int userId,LocalDateTime holdUntil) throws SQLException;

    boolean releaseHeldSeat(
    ...
    boolean confirmHeldSeat(Connection connection,int showSeatId,int userId) throws SQLException;
}
